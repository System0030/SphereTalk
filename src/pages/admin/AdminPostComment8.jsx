...
const randomComments = [
  "Kailangan talaga ng rules bago pa mahuli ang lahat.",
  "Scary how fast AI is evolving!",
  "Regulation = protection. Di ito panira sa innovation.",
  "Europe leading again with tech policies.",
  "Dapat clear ang lines between helpful AI at abusive AI.",
  "Saludo sa mga gumagawa ng batas para dito.",
  "Ang AI, parang superhero—pwedeng magligtas o manira.",
  "Importante ang balance between freedom and security.",
  "Mas okay regulated kaysa maging tool for exploitation.",
  "Hindi tayo laging handa sa tech—kaya dapat regulated."
];
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">Deep Dive: The Impact of AI Regulation in the U.S. and Europe</h2>
              <p className="text-gray-400 mb-4">
              AI regulation is a hot topic. We break down the latest laws and their implications for tech companies and consumers.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/RpkRCgHq/user-3-p.jpg" 
                alt="Post"
