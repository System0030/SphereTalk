...
const randomComments = [
  "Nakakarelax talaga pag Slice of Life ang genre 😌",
  "Kahit walang labanan, feel good pa rin!",
  "Gusto ko yung simple lang pero ang lalim ng kwento 😭",
  "Perfect pang-pahinga ang Slice of Life after stressful school/work.",
  "Yung vibe ng 'Your Lie in April' sobrang swak sa topic na to!",
  "Kung gusto mong umiyak nang walang dahilan, Slice of Life is the way!",
  "Di man intense, pero grabe tama sa puso.",
  "Mahilig ako sa action dati, pero nahulog na ko sa Slice of Life.",
  "Ang charm talaga ng slow-paced anime is unmatched.",
  "True! Sa gulo ng mundo, minsan chill anime lang kailangan mo."
];
...
const Dashboard = () => {
  ...
  const handleCommentSubmit = (e) => {
    ...
    const newCommentObject = {
      id: Date.now(),
      text: newComment,
      name: "AnimeCoon", // Set a default name for the user posting the comment
      likes: 0,
      profilePic: "https://i.ibb.co/QvL32B2L/coop-link-loz-1.jpg"
    };
  ...
  const handleHomeClick = () => {
    navigate("/Admindashboard");  // Navigate to Dashboard route
  };
  const handlePopularClick = () => {
    navigate('/Adminpopular'); // Navigate to Explore page
  };
  const handleExploreClick = () => {
    navigate('/Adminexplore'); // Navigate to Explore page
    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="hidden lg:flex items-center justify-between px-6 py-4 bg-black border-b border-gray-700 fixed top-0 left-0 w-full z-50">
        ...
        <div className="flex items-center gap-4">
          <button onClick={() => navigate("/Admincreate-post")} className="bg-white text-red-500 font-semibold px-4 py-2 rounded hover:bg-gray-300">
            ＋ CREATE
          </button>
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">Why Slice of Life Anime Is Gaining Popularity</h2>
              <p className="text-gray-400 mb-4">
              In a chaotic world, slow-paced, emotional narratives are resonating more than ever. Here's why audiences crave the calm.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/7xYdqCWZ/anime-2.png" 
                alt="Post"
