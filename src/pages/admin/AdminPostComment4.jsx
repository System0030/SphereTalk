...
const randomComments = [
  "Ghibli movies never get old ❤️",
  "Spirited Away will always be legendary!",
  "Totoro is basically my childhood mascot 🐱",
  "The way Ghibli combines fantasy and life lessons is pure art.",
  "Di lang pangbata, panglahat talaga ang Ghibli.",
  "Laging may magic yung animation nila!",
  "Studio Ghibli shaped my imagination growing up.",
  "Parang may soul yung bawat pelikula nila.",
  "Walang tapon sa Ghibli films, lahat classic!",
  "Miyazaki is truly a master storyteller."
];
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">The Cultural Impact of Studio Ghibli Across Generations</h2>
              <p className="text-gray-400 mb-4">
             From My Neighbor Totoro to Spirited Away, Ghibli’s stories continue to influence animation, art, and storytelling globally.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/dJD47mnj/anime-4.jpg" 
                alt="Post"
