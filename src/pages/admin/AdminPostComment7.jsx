...
const randomComments = [
  "Kailan pa tayo gagalaw kung hindi ngayon?",
  "Sana all gobyerno may real action against climate change.",
  "Laging nature ang talo sa dulo 😢",
  "Nakakatakot isipin future kung walang action ngayon.",
  "Buti may mga bansang leading the charge!",
  "Policy is power. Use it to save the planet.",
  "Sana tularan ng ibang bansa yung proactive ones.",
  "Climate justice is not just a trend—it’s a need.",
  "Dapat priority lagi ang sustainability.",
  "Hindi sapat yung post lang sa social media. Action dapat!"
];
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">Global Warming and Policy: Which Countries Are Leading Change?</h2>
              <p className="text-gray-400 mb-4">
              With climate urgency rising, we examine which governments are truly taking action—and which are falling behind.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/g0Jh7QZ/user-2-p.jpg" 
                alt="Post"
