...
const randomComments = [
  "Every year may bagong pasabog sa politics!",
  "Minsan mas exciting pa to kaysa teleserye 😅",
  "Nakakalungkot pero di na nakakagulat 😔",
  "Scandals show us who’s really in power.",
  "Dapat may accountability, hindi lang exposé.",
  "Some of these changed the entire political landscape.",
  "Grabe yung impact sa tiwala ng tao.",
  "The more you read, the more disappointed you get...",
  "Minsan gusto ko na lang mag-unplug sa news.",
  "Gamitin natin ang info para pumili ng better leaders."
];
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">Top 5 Political Scandals of the Last Decade</h2>
              <p className="text-gray-400 mb-4">
              Scandals shape public opinion and policy. We look back at the most shocking moments that rocked the political world.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/rGNQJRMC/user-4-p.jpg" 
                alt="Post"
