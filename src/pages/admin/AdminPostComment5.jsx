...
const randomComments = [
  "Manga is better for pacing, anime for visuals!",
  "Pag nagmamadali ako, manga muna 😅",
  "Walang filler sa manga kaya solid!",
  "Anime gives life sa characters, especially with soundtracks.",
  "Minsan nakakadismaya yung adaptation 😭",
  "Both have strengths—depende sa mood ko.",
  "Gusto ko magbasa muna ng manga bago nood.",
  "Manga fans: 'That scene was better in the manga' 😂",
  "Voice acting sa anime brings a different level!",
  "Reading manga feels more personal, parang ikaw ang director."
];
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">Anime vs Manga: Which Tells the Story Better?</h2>
              <p className="text-gray-400 mb-4">
              Is it better to watch the action or read the nuance? We explore the strengths of both formats in storytelling.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/tTXqcJd1/anime-5.jpg" 
                alt="Post"
