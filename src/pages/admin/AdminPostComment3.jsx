...
const randomComments = [
  "Mas gusto ko pa nga yung ibang underrated kesa sa mainstream.",
  "Thanks sa listahan, hanap ako ng bago babasahin!",
  "Ang daming hidden gems sa manga world!",
  "Wala sa sikat yan, nasa quality ng kwento 💯",
  "Yung iba dito dapat talagang mabigyan ng anime adaptation!",
  "Legit goosebumps kahit hindi kilala!",
  "Sulit to para sa mga gusto ng bagong mabasa!",
  "Sana may part 2 ng list na ‘to soon!",
  "Underrated pero overpowered sa feels at art style!",
  "Finally! Someone talks about manga na hindi mainstream!"
];
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">Underrated Manga You Should Be Reading in 2025</h2>
              <p className="text-gray-400 mb-4">
              Skip the mainstream—these hidden gems pack emotional punch, incredible art, and deep lore you won't want to miss.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/0RY2GwhT/anime-3.jpg" 
                alt="Post"
