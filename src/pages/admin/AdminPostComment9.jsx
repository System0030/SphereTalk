...
const randomComments = [
  "Nakakatakot kung paano ginagamit ang tech sa surveillance 😨",
  "Freedom online is just as important as offline.",
  "Grabe, ibang level na ang censorship ngayon.",
  "We need laws that protect user rights, not suppress them.",
  "Dapat may transparency sa tech use ng gobyerno.",
  "Privacy isn’t a privilege—it’s a right!",
  "Ito na talaga ang bagong battleground ng freedom.",
  "Watchdogs and whistleblowers, salute to you!",
  "The internet should be a space for truth, not control.",
  "Parang Black Mirror na sa totoong buhay 😬"
];
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">What Is Digital Authoritarianism? And Why It’s Spreading</h2>
              <p className="text-gray-400 mb-4">
              Digital authoritarianism is on the rise. We explore its implications for privacy, freedom, and democracy.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/fGd2YSnr/user-5-p.jpg" 
                alt="Post"
