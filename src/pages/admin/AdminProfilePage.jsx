...
import { usePostContext } from "../../context/PostContext"; // ✅ one import only
          ...
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <section className="flex-1 space-y-6">
              <div className="bg-gray-900 p-6 rounded-xl shadow-md">
                ...
                <button
                  onClick={() => navigate("/Admincreate-post")}
            ...
            <aside className="w-full lg:w-[280px] bg-gray-900 p-6 rounded-xl shadow-md">
              ...
              <div className="mt-6">
                ...
                <button className="px-4 py-2mt-2 text-red-600 hover:text-red-500">
                  <img
                    src="https://i.ibb.co/n817HYBj/share.png"
                    alt="Share Icon"
