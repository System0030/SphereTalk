...
const randomComments = [
  "Tayo na talaga ang pag-asa ng bayan.",
  "Gen Z showing up strong, love to see it 💪",
  "Every vote matters, especially now!",
  "Mas aware na tayo ngayon sa politics.",
  "Sana tuloy-tuloy na yung ganitong participation.",
  "Nakakainspire na maraming kabataan ang bumoboto.",
  "This generation isn't just loud online—they're active IRL too.",
  "Tama na pagiging apolitical. Voice mo, gamitin mo!",
  "Respect sa mga unang beses bumoto this year!",
  "Kahit isang boto mo lang, may impact yan."
];
       ...
       <main className=" box-border w-[screen] sm:w-[screen] flex-1 p-4 lg:p-8 bg-[#111] min-h-screen">
          <div className="w-full sm:w-[150%] lg:w-[100%] flex flex-col lg:flex-row gap-6">
            ...
            <div className="post-section mb-4">
              <h2 className="text-2xl font-bold text-white mb-4">Youth Voter Turnout: Why It Matters More Than Ever in 2025</h2>
              <p className="text-gray-400 mb-4">
              Gen Z is showing up and changing the political landscape—this is what that means for upcoming elections.
              </p>
                <div className="flex-wrap justify-center gap-500 border-5  border-gray-700 rounded-lg p-4 mb-4">
              {/* Post Image */}
              <img
                src="https://i.ibb.co/YFsyHknz/user-1-p.png" 
                alt="Post"
